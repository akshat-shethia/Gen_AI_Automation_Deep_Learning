...
st.number_input("Enter A Number Here", 0, 10, key="num_input")
# Callbacks
...
st.radio("Select a range", ["7 days", "28 days",
         "custom"], horizontal=True, key="radio_range", on_change=add_time)

col1, col2, col3 = st.columns(3)

col1.date_input("Start date", key="start_date", on_change=add_time)
col2.date_input("End date", key="end_date", on_change=sub_time)
