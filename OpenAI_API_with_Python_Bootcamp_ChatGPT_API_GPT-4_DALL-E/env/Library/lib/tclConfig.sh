...
# installed.
TCL_PREFIX='C:/miniconda/Gen_AI_Automation_Deep_Learning/OpenAI_API_with_Python_Bootcamp_ChatGPT_API_GPT-4_DALL-E/env\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/miniconda/Gen_AI_Automation_Deep_Learning/OpenAI_API_with_Python_Bootcamp_ChatGPT_API_GPT-4_DALL-E/env\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/miniconda/Gen_AI_Automation_Deep_Learning/OpenAI_API_with_Python_Bootcamp_ChatGPT_API_GPT-4_DALL-E/env\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/miniconda/Gen_AI_Automation_Deep_Learning/OpenAI_API_with_Python_Bootcamp_ChatGPT_API_GPT-4_DALL-E/env\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/miniconda/Gen_AI_Automation_Deep_Learning/OpenAI_API_with_Python_Bootcamp_ChatGPT_API_GPT-4_DALL-E/env\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/miniconda/Gen_AI_Automation_Deep_Learning/OpenAI_API_with_Python_Bootcamp_ChatGPT_API_GPT-4_DALL-E/env\Library\lib\tclstub86.lib'
